...
# Example usage:
input_folder = 'ASI'  # Folder containing the input XLSX files
merged_folder = 'merged_ASI'  # Folder to save the merged CSV
merged_filename = 'merged_emails_ASI.csv'  # Name of the merged CSV file
output_folder = 'split_emails_ASI'  # Folder to save the split CSV files
